...
const showDesktopAside = computed(() => !noDesktopAsideRoutes.includes(route.name as string))
...
/** 导航项（badge 为角标数，可选） */
  interface NavItem { path: string; label: string; icon: string; activeIcon: string; badge?: number }
